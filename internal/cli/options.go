...
type Options struct {
	...
	Workdir string `short:"d" long:"workdir" description:"The directory to place archived threads and logs in" default:"./archive"`
	...
	Threads int  `short:"T" long:"threads" description:"The number of goroutines to use to archive chatbot threads" default:"5" validate:"gte=1,lte=10"`
	Debug   bool `short:"D" long:"debug" description:"Whether to run the program in debug mode (show browser window and dev tools)"`
